...
class pydantic_lemma(pydantic.BaseModel):
   ...
   FulaDialects: Optional[List[str]]  #article
   ...
   for indexes,para_inds in workinglemmas.items():
      ...
      for key,ind in {'lemma':lemma_index,'root':root_index,'root_subpiece':root_subpiece_index}.items():
         ...
         if not np.isnan(ind):
            ...
            # if    key == 'lemma':
               # lemma = pydantic_lemma(**values)
               # print(lemma)
            # elif  key == 'root':
               # root = pydantic_root(**values)
               # print(root)
            # elif  key == 'root_subpiece':
               # root_subpiece = pydantic_root_subpiece(**values)
               # print(root_subpiece)
         else:
            pass
...
if __name__ == '__main__':
   ...
   #    if e.lemma.FulaPOSClass == ['Noun']:
   #       # print(e)
   #       noun_entries.append(e)
   #    elif e.lemma.FulaPOSClass == ['Verb']:
   #       # print(e)
   #       verb_entries.append(e)
   #    elif e.lemma.FulaPOSClass == ['Other_']:
   #       # print(e)
   #       verb_entries.append(e)
